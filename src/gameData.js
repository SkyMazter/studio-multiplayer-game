...
import Slayers from "./games/Slayers/App.jsx";
...
const gameData = {
  ...
  BootlegDND: {
    title: "Slayers",
    authors: "Oscar Communidad, Ariana Hernandez, Matthew Schupack, Mike Tobia",
    description: "A collaborative dragon fighting game",
    minUsers: 1,
    maxUsers: 2,
    component: Slayers
  }
